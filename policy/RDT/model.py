...
class RDT:
    ...
    def __init__(
        ...
        self.config = {
            ...
            "state_dim": left_arm_dim + 1 + right_arm_dim + 1,  # 14 dims action:[left joint angles,left gripper,right joint angles,right gripper]
    ...
    def set_language_embed(self):
        GPU = 0
        MODEL_PATH = os.path.join("/workspace/ckpt/weights/RDT/t5-v1_1-xxl")
        CONFIG_PATH = os.path.join(self.global_path, "RDT/configs/base.yaml")
    ...
    def make_policy(self, args):
        ...
        pretrained_vision_encoder_name_or_path = os.path.join("/workspace/ckpt/weights/RDT/siglip-so400m-patch14-384")
        model = create_model(
            args=args["config"],
